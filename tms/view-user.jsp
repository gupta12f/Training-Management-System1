...
<%
		...
		else if(request.getParameter("id")==null)
			{
				...
				String Data="<table>";
					...
					if(!((rs.getString("profilepic"))==null))
							{
								Data+="<tr><td>Profile Pic</td><td><img width=70px height=80px src=\"uploads//"+rs.getString("profilepic") +"\"/></td></tr>";
							}
						else
							{
								Data+="<tr><td>Profile Pic</td><td><img width=70px height=80px src=\"uploads//default.png\"/></td></tr>";
						
							}
						
                        
						Data+="<tr><td>UserID</td><td>"+rs.getString("userid") +"</td></tr>"+
	...
	catch(Exception e)
	{
		ResultSet rs=objUser.getUser(session.getAttribute("UserID").toString());
        rs.next();
        System.out.println("this is image "+rs.getString("profilepic"));
